...
/**
 * AddCard-GUI realisiert ein Fenster zum erstellen einer Karte für die Lernkartei 
 * erbt von JDialog
...
public class AddCardGUI extends JDialog {
	...
	public AddCardGUI(JFrame owner) {
		...
		firstDescTitle.setBounds(55, 155, 120, 20);
		...
		//Beschreibung wird aus der VokabeltrainerDB geholt
		...
		firstWord.setBounds(55, 205, 50, 20);
		...
		//Zweite Beschreibung wird aus VokabeltrainerDB geholt
			...
			if (e.getSource().equals(add)) {
			    ...
			    switch(ret) {
			    	...
			    	case -2: {
			    		...
			    		JOptionPane.showMessageDialog(AddCardGUI.this, 
			    				"Bitte geben Sie alle nötigen Informationen ein! - Karte nicht vollständig", 
			    				"Fehler!", JOptionPane.ERROR_MESSAGE);
			    		break;
			    	}
			    	case -5: {
