 ...
 * erbt von JFrame
 * wurde verbessert, indem unnötige Casts entfernt wurden, 
 * da dynamische Typisierung in MeineDefaultListe.java implementiert wurde
				...
				//wenn liste nicht leer
					...
					if (weiter) {
						...
						if (auto == null) {
							...
							//erstes Element
							auto = autoIterator.naechstesElement();
						}
