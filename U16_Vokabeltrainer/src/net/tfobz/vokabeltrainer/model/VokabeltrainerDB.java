...
{
	public static final String DB_NAME = "lernkarteien";

	public static final String CREATE_EINSTELLUNGEN = "CREATE TABLE einstellungen( "
	...
	public static final String CREATE_LERNKARTEIEN = "CREATE TABLE lernkarteien( "
	...
	public static final String CREATE_FAECHER = "CREATE TABLE faecher( "
	...
	public static final String CREATE_KARTEN = "CREATE TABLE karten( "
	...
	public static final String DROP_EINSTELLUNGEN = "DROP TABLE einstellungen IF EXISTS;";
	public static final String DROP_LERNKARTEIEN = "DROP TABLE lernkarteien IF EXISTS;";
	public static final String DROP_FAECHER = "DROP TABLE faecher IF EXISTS;";
	public static final String DROP_KARTEN = "DROP TABLE karten IF EXISTS;";

	public static final String INSERT_LERNKARTEI1 = "INSERT INTO lernkarteien(lbeschreibung, lworteinsbeschreibung, lwortzweibeschreibung, lrichtung, lgrosskleinschreibung) "
			+ "  VALUES('Vokabeltrainer Deutsch Englisch','Deutsch','Englisch',true,false);";
	public static final String INSERT_LERNKARTEI2 = "INSERT INTO lernkarteien(lbeschreibung, lworteinsbeschreibung, lwortzweibeschreibung, lrichtung, lgrosskleinschreibung) "
			+ "  VALUES('Vokabeltrainer Deutsch Italienisch','Deutsch','Italienisch',false,true);";
	public static final String INSERT_LERNKARTEI3 = "INSERT INTO lernkarteien(lbeschreibung, lworteinsbeschreibung, lwortzweibeschreibung, lrichtung, lgrosskleinschreibung) "
			+ "  VALUES('Vokabeltrainer Deutsch Franz�sisch','Deutsch','Franz�sisch',false,true);";
	public static final String INSERT_FACH11 = "INSERT INTO faecher(fbeschreibung, ferinnerung, fgelerntam, lnummer) "
			+ "  VALUES('Fach 1',0,'" + getActualDate() + "', 1);";
	public static final String INSERT_FACH21 = "INSERT INTO faecher(fbeschreibung, ferinnerung, fgelerntam, lnummer) "
